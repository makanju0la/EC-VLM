...
def build_pretraining_dataset_url(in_split, outfile, args):
    ...
    for line in data:
        ...
        url = line['url']
        count += 1
        img = img_string_to_img_from_url(url)
...
if __name__ =="__main__":
    ...
    in_test = "/data/datasets/EC_pretraining/OFA/dataset/minigptv/test_file.json"
    out_test_ec = "/data/datasets/EC_pretraining/OFA/dataset/minigptv/test_file_ec.json"
    out_file_cc = "/data/datasets/EC_pretraining/OFA/dataset/minigptv/ccs_synthetic_filtered_large_EC.json"
    build_pretraining_dataset_url(in_test, out_test_ec, args)