...
log_dir=./refcocoplus_EC_logs_exp2
save_dir=./refcocoplus_EC_checkpoints_exp2
...
data=${data_dir}/refcocoplus_train_EC.tsv,${data_dir}/refcocoplus_val.tsv
restore_file=../../model_checkpoints/ofa_base.pt
