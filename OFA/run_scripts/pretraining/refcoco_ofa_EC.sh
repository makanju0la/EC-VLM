...
data_dir=/data/datasets/EC_pretraining/OFA/dataset/pretrain/ec_language
data_dir1=/data/datasets/EC_pretraining/OFA/dataset/pretrain/natural_language
neg_sample_dir=${data_dir1}/negative_sample
data=${data_dir}/EC_full_pretrain_vre_caption_vqa_new.tsv   #need to update this for EC
text_data=${data_dir1}/text_examples.tsv
image_data=${data_dir1}/image_examples.tsv
detection_data=${data_dir1}/detection_examples.tsv
