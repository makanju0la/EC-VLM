...
# Number of GPUs per GPU worker (was 8)
GPUS_PER_NODE=1
# Number of GPU workers, for single-worker training, please set to 1 (was 4)
WORKER_CNT=1
...
echo e1
# data_dir=../../dataset/vqa_data       # CHANGE
data_dir=/projects/virtual_presenter/veqa/vqa_data_ofa
data=${data_dir}/vqa_train_s2.tsv,${data_dir}/vqa_val.tsv 
...
ans2label_file=/projects/virtual_presenter/veqa/vqa_data_ofa/trainval_ans2label.pkl
restore_file=../../model_checkpoints/ofa_base.pt     # best check point from pretraining on ec text or just keep ofa_base when doing
selected_cols=0,5,2,3,4
echo e2
log_dir=./vqa_logs_nlfinetune            # can change to new folder reflecting which experiment you run
save_dir=./vqa_checkpoints_nlfinetune
