...
export MASTER_PORT=1057

log_dir=./stage1_logs/nl_base    #change between ec and nl
save_dir=./stage1_checkpoints/nl_base  #change between ec and nl
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=/data/datasets/EC_pretraining/OFA/dataset/caption/caption_data
data=${data_dir}/caption_stage1_train.tsv,${data_dir}/caption_val.tsv
# restore_file=/home/grads/mogunleye/Research/EC_pretraining/OFA/model_checkpoints/ofa_base.pt   #change between ec and nl
selected_cols=0,4,2

task=caption
arch=ofa_base   #change to base model
