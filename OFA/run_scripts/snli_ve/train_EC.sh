...
export MASTER_PORT=7063

log_dir=./EC_10k_logs
save_dir=./EC_10k_checkpoints
...
data=${data_dir}/snlvi10k.tsv,${data_dir}/snlvi_dev_2k.tsv
restore_file=../../run_scripts/pretraining/checkpoints_EC/checkpoint_17_492000.pt
