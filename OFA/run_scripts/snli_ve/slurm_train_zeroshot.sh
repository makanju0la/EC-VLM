...
# /data/datasets/EC_pretraining/OFA/dataset/snli_ve_data
log_dir=./new_logs/base
save_dir=./new_checkpoints/base
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=/data/datasets/EC_pretraining/OFA/dataset/snli_ve_data
