#!/bin/bash
#Change GPU addresses
#Change data_path to respective data path. Latest we used EC corpus 
#---generated by speaker agent with token length 15 and vocab size 1000. Size of data = 100K
#Change output_dir
